...
import 'package:alessa_v2/controllers/ProfitAndLoss/insertJournalProfitLostClDetsController.dart';
import 'package:alessa_v2/controllers/ProfitAndLoss/updateWmsJournalProfitLostClQtyScannedController.dart';
...
class ProfitAndLossScreen1 extends StatefulWidget {
  const ProfitAndLossScreen1({super.key});

  @override
  State<ProfitAndLossScreen1> createState() => _ProfitAndLossScreen1State();
}

class _ProfitAndLossScreen1State extends State<ProfitAndLossScreen1> {
                    ...
                    child: MultiSelectDialogField(
                      ...
                      onConfirm: (values) {
                        ...
                        setState(() {
                          filterTable = table
                              .where((element) =>
                                  itemIdValue.contains(element.iTEMID))
                              .toList();
                          total = filterTable.length.toString();
                  ...
                  child: TextFormFieldWidget(
                    ...
                    onEditingComplete: () {
                      ...
                      ValidateItemSerialNumberForJournalMovementCLDetsController
                          .getData(
                        serialNo.trim(),
                        'validateItemSerialNumberForJournalProfitLostCLDets',
                      ).then((validate) {
                        if (filterTable
                            .where((element) =>
                        ...
                        updateWmsJournalProfitLostClQtyScannedController
                            .getData(
                          filterTable
                              .where((element) =>
                                  element.iTEMID.toString().trim() ==
                          ...
                          insertJournalProfitLostClDetsController
                              .getData(
                            updateWmsJournalMovementClQtyScannedList,
                            serialNo.trim(),
                          )
